package co.com.it2ex.it2pay.util.negocio.api.rest.listadetalle;
...
import co.com.it2ex.it2pay.util.negocio.servicios.listadetalle.ServicioListaDetalle;
...
@RestController
public class RestListaDetalle {

    @Autowired
    LoggerAuditoriasComponent loggerAuditoriasComponent;

    @Autowired
    private ServicioListaDetalle servicioListaDetalle;
     ...
     * @throws Exception
     */
    @RequestMapping(value = ConstantesSeguridadPathRest.PATH_LISTADETALLE_POR_ID, params={ "id" }, method = RequestMethod.GET, headers = "Accept=" + MediaType.APPLICATION_JSON_UTF8_VALUE)
    public ResponseEntity<ListaDTO> getListaDetallePorIdPais(ModelMap model, Principal principal, @RequestParam Long id) throws Exception{
        ...
        try {
            ...
            respuesta = servicioListaDetalle.consultaListaDetallePorId( id );
